  ...
  try {
    ...
    if (userExists || profileExists) {
      ...
      if (userExists && profileExists) {
        ...
        if (preserveSeniorManagement) {
          finalRole = 'Senior Management'
          finalTeamId = 'senior-management'
        } else if (preserveHRManager) {
          // Preserve Manager role in HR team
          finalRole = 'Manager'
          finalTeamId = 'hr'
          console.log('🛡️ Preserving Manager role in HR team for user:', email)
        }
